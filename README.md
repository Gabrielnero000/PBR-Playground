 ...
 * **Class Ray** - represents the most basic element in a Ray Tracer: a ray. A ray, wich is a straight line, can be expressed as $f(t) = O + tD$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODY1Njk5OSw0MDA1OTg0Miw5MjAxNz
