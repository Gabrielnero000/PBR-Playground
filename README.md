...
When the light rays colide with an object, that object absorbs part of the energy (part of the light, basically) and reflects the rest of it. If the reflected rays colide with our eye, they stimulate special cells (cones and rods). That stimulus is interpreted by the brain 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyNzAzMjg0LDIxMjg1OTAzODcsLTE1Mz
