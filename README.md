 ...
 * **Class Render** - that's were the magic happens. The render loop is essecially two nested for loops (using output's resolution), were the rays are generate
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM2NDIzNDQyNyw0MDA1OTg0Miw5MjAxNz
