...
So, instead Ray and Path Tracing essencially trace back the light  rays from the eye, to the objects and to the light (that's were the "tracing" comes from)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDY2MjcxMTgsLTE2MTMzOTkzNjAsMj
