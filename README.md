...
When the light rays colide with an object, that object absorbs part of the energy (part of the light, basically) and reflects the rest of it. If the reflected rays colide with our eye, they stimulate special cells (cones and rods). The interpretation by the brain of that stimulus is what we understand as **color**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE0NDI3MzE3LDIxMjg1OTAzODcsLTE1Mz
