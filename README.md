...
When the light rays colide with an object, that object absorbs part of the energy (part of the light, basically) and reflects the rest of it. If the reflected rays colide 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0OTgxMzM2NjQsMjEyODU5MDM4NywtMT
